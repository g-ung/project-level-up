# AI Porgamming with Python: Lesson 7 Object-Oriented Programming, Module 6 OOP Syntax, SalesPerson class
### TODO:
...
#    Returns:
#        None
    def sell_pants(self, sell_items):
        self.pants_sold.append(sell_items)
...
###
    def display_sales(self):
        for pant in self.pants_sold:
            print("Colour: {}, waist size: {}, length: {}, price: {}".format(pants.color, pants.waist_size, pants.length, pants.price))
...
###
    def calculate_commission(self, commission_percentage):
        ...
        return sales_total * commission_percentage
