...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        self.stdev = math.sqr(self.n * self.p * (1 - self.p))
    ...
    def plot_bar(self):
        ...
        plt.bar(x = ['0', '1'], heigh = [(1 - self.p) * self.n, self.p * self.n])
    ...
    def plot_bar_pdf(self):
        ...
        # calculate x to vislulise
        for in in range(self.n + 1):
            x.append(i)
            y.append(self.pdf(i))
        
        # build the graph
        plt.bar(x, y)
        plt.title("Distribution of Outocme")
